...
public class Temperature1
{
    ...
    //Constructors to specify both temperature and units.
    ...
    public void writeC()
    {
        switch(units)
        {
            ...
            case 'f':
                ...
                //Divide by 10.0 so division resualt is floating point
    ...
    //an invailed charater (other than c, C, f, or F).
    ...
    //units (allows the character, not just c, C, f, or F).
    
    public void setDegreesUnits(double newDegrees, char newUnits)
    {
        degrees = newDegrees;
        units = newUnits;
    }
    ...
    public void setUnits(char newUnits)
    {
        units = newUnits;
    }
